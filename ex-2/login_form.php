                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <form action="process_login_form.php.php" method="post"enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="login" id="register1"
                                        class="btn btn-success btn-block btn-lg gradient-custom-4 disabled">Login</button>
                                </div>

                                <p class="text-center text-muted mt-5 mb-0">Does not have an account? <a href="registration_form.php"
